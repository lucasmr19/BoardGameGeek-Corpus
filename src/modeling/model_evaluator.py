...
from .hyp_params_tuner import HyperparameterTuner
...
class ModelEvaluator:
    ...
    def _generate_technical_report(self):
        ...
        # Sort by test test_avg_acc_prec_rec_f1
        sorted_results = sorted(self.results, key=lambda x: x['test_avg_acc_prec_rec_f1'], reverse=True)
        ...
        with open(report_path, 'w', encoding='utf-8') as f:
            ...
            f.write("EVALUATION RESULTS (sorted by Test Avg 0.25xAcc + 0.25xPrec + 0.25xRec + 0.25xF1)\n")
            f.write("-"*70 + "\n\n")
